 ...
 * @author U Computers
 */
public class insertCards extends javax.swing.JFrame {

    /**
     * Creates new form insertCards
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(68, 103, 82, 14);

        jLabel2.setText("SUBJECT NAME");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(68, 195, 74, 14);

        jLabel3.setText("NUMBER OF CARDS");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(68, 284, 95, 14);

        getContentPane().add(lecNameText);
        lecNameText.setBounds(294, 100, 148, 20);

        getContentPane().add(subNameText);
        subNameText.setBounds(294, 192, 148, 20);
        getContentPane().add(cardText);
        cardText.setBounds(294, 284, 148, 20);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String lecNames=lecNameText.getSelectedItem().toString();
        String subNames=subNameText.getSelectedItem().toString();
        String cardNum=cardText.getText();
        insertCardsMiddle icm=new insertCardsMiddle();
        icm.cardMonthly(lecNames, subNames, cardNum);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insertCards.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new insertCards().setVisible(true);
            }
        });
    }
