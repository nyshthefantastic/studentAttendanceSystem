...
import middle.others.updateRegistrationFeeMiddle;
 ...
 * @author U Computers
 */
public class updateRegistrationfee extends javax.swing.JFrame {

    /**
     * Creates new form updateRegistrationfee
     */
    private static String page=null;
    public updateRegistrationfee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NEW REGISTRATION FEE AMOUNT");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(77, 89, 168, 14);
        getContentPane().add(feeText);
        feeText.setBounds(365, 86, 222, 20);
        ...
        jButton1.setBounds(365, 172, 222, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String newFee=feeText.getText();
        message msg=new message();
        boolean conff=msg.alertBox("ARE YOU SURE YOU WANT TO CHANGE REGISTRATION FEES");
        if(conff==true){
            
            updateRegistrationFeeMiddle urfm=new updateRegistrationFeeMiddle();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateRegistrationfee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateRegistrationfee().setVisible(true);
            }
        });
    }
