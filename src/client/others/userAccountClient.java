 ...
 * @author U Computers
 */
public class userAccountClient extends javax.swing.JFrame {

    /**
     * Creates new form userAccountClient
     */
    ...
    private void initComponents() {
        ...
        ulevelText = new javax.swing.JComboBox<>();
        ...
        jLabel1.setBounds(98, 76, 54, 14);
        getContentPane().add(username);
        username.setBounds(272, 73, 158, 20);

        jLabel2.setText("PASSWORD");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(98, 142, 57, 14);
        getContentPane().add(password);
        password.setBounds(272, 139, 158, 20);

        jLabel3.setText("ACCESS LEVEL");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(98, 212, 70, 14);

        ulevelText.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "admin", "other" }));
        getContentPane().add(ulevelText);
        ulevelText.setBounds(272, 209, 158, 20);
        ...
        jButton1.setBounds(272, 289, 158, 55);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ulevel=ulevelText.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userAccountClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new userAccountClient().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> ulevelText;
