...
import middle.pay.lecAdvanceMiddle;
 ...
 * @author U Computers
 */
public class lecAdvanceClient extends javax.swing.JFrame {

    /**
     * Creates new form lecAdvanceClient
     */
    private static String page=null;
    Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    lecAdvanceMiddle lam=null;
 message mess = null;
    public lecAdvanceClient() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(77, 121, 82, 14);

        jLabel2.setText("ADVANCE AMOUNT");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(77, 246, 93, 14);

        getContentPane().add(lecNameText);
        lecNameText.setBounds(325, 118, 125, 20);
        getContentPane().add(advanceText);
        advanceText.setBounds(325, 243, 125, 20);

        jButton1.setText("CHECK ADVANCE");
        ...
        jButton1.setBounds(77, 358, 142, 43);
        ...
        jButton2.setBounds(325, 358, 125, 43);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lam=new lecAdvanceMiddle();
        String lecName=lecNameText.getSelectedItem().toString();
        String advanceAmt=advanceText.getText();
          mess = new message();
        boolean bool=lam.checkAdvance(lecName, advanceAmt);
        if(bool==true){
         ...
         mess.messageBox("SORRY THE AMOUNT IS NOT AVAILABLE!.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String advanceAmt=advanceText.getText();
         boolean bool=lam.checkAdvance(lecName, advanceAmt);
      if(bool==true){
             lam.payAdvance(lecName, advanceAmt);
                mess.messageBox("ADVANCE PAID!.");
         }
      else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lecAdvanceClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lecAdvanceClient().setVisible(true);
            }
        });
    }
