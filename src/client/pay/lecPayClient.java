...
import middle.pay.lecPayMiddle;
 ...
 * @author U Computers
 */
public class lecPayClient extends javax.swing.JFrame {

    /**
     * Creates new form lecPayClient
     */
    private static String page=null;
      Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    lecPayMiddle lpm=null;
    public lecPayClient() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(74, 107, 82, 14);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(74, 218, 0, 0);

        getContentPane().add(lecNameText);
        lecNameText.setBounds(492, 104, 174, 20);
        getContentPane().add(dateText);
        dateText.setBounds(492, 224, 174, 22);

        jLabel3.setText("CORROSPONDING MONTH AND YEAR");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(74, 224, 207, 22);
        ...
        jButton1.setBounds(492, 335, 174, 61);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lpm.pay(lecturer, year, month, date);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lecPayClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lecPayClient().setVisible(true);
            }
        });
    }
