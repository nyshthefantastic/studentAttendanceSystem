 ...
 */
package client.pay;
import middle.pay.pettyCashMiddle;
 ...
 * @author U Computers
 */
public class pettyCashClient extends javax.swing.JFrame {

    /**
     * Creates new form pettyCashClient
     */
    private static String page=null;
    pettyCashMiddle pcm=new pettyCashMiddle();
    public pettyCashClient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(84, 138, 41, 14);

        reasonText.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SALARIES", "FOOD", "DECORATION", "CLEANING", "MARKETING", "EQUIPMENT", "OTHERS" }));
        reasonText.setToolTipText("");
        getContentPane().add(reasonText);
        reasonText.setBounds(280, 135, 155, 20);

        jLabel2.setText("AMOUNT");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(84, 230, 43, 14);
        getContentPane().add(amountText);
        amountText.setBounds(280, 227, 155, 20);
        ...
        jButton1.setBounds(280, 329, 155, 49);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pettyCashClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pettyCashClient().setVisible(true);
            }
        });
    }
