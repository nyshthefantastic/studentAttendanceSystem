...
import common.checkMonths;
import common.dbconnct;
import java.sql.Connection;
import java.sql.PreparedStatement;
import java.sql.ResultSet;
import middle.pay.studentFeesMiddle;
 ...
 * @author U Computers
 */
public class studentFeesClient extends javax.swing.JFrame {

    /**
     * Creates new form studentFeesClient
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(58, 125, 51, 14);

        jLabel2.setText("Subject");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(58, 254, 36, 14);
        getContentPane().add(studentName);
        studentName.setBounds(287, 122, 193, 20);

        getContentPane().add(subjectName);
        subjectName.setBounds(287, 251, 193, 20);
        ...
        jButton1.setBounds(287, 350, 193, 65);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        studentFeesMiddle sfm=new studentFeesMiddle();
        sfm.fees(student, subject);
...
public void renew(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentFeesClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentFeesClient().setVisible(true);
            }
        });
    }
