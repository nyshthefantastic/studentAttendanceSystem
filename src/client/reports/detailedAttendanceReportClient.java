 ...
 * @author U Computers
 */
public class detailedAttendanceReportClient extends javax.swing.JFrame {
private static String page=null;
    /**
     * Creates new form detailedAttendanceReportClient
     */
      Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public detailedAttendanceReportClient() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(56, 87, 105, 43);

        jLabel2.setText("SUBJECT NAME");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(56, 188, 105, 49);

        jLabel3.setText("MONTH & YEAR");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(56, 267, 86, 46);
        getContentPane().add(stuIdText);
        stuIdText.setBounds(222, 98, 153, 20);

        getContentPane().add(subNameText);
        subNameText.setBounds(222, 202, 153, 20);
        getContentPane().add(dateText);
        dateText.setBounds(222, 279, 153, 22);
        ...
        jButton1.setBounds(222, 343, 153, 47);
        ...
        jScrollPane1.setBounds(56, 424, 783, 402);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/defbackground.jpg"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(-6, -6, 1210, 890);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String subjectName=subNameText.getSelectedItem().toString();
        ...
        darm.searchAttendance(jTable1, "SELECT Datee FROM permananthistory WHERE subName='" + subjectName + "' AND studentId='" + studentId + "' AND Year='" + yearr + "' Month='" + monthh + "'", subjectName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detailedAttendanceReportClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new detailedAttendanceReportClient().setVisible(true);
            }
        });
    }
