 ...
 * @author U Computers
 */
public class lecturerReportClient extends javax.swing.JFrame {

    /**
     * Creates new form lecturerReportClient
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(50, 72, 82, 14);

        jLabel2.setText("DATE");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(50, 153, 82, 14);

        getContentPane().add(lecNameText);
        lecNameText.setBounds(236, 69, 172, 20);
        getContentPane().add(dateText);
        dateText.setBounds(236, 153, 172, 22);
        ...
        jButton1.setBounds(236, 216, 172, 23);
        ...
        jButton2.setBounds(236, 270, 172, 23);
        ...
        jScrollPane1.setBounds(50, 344, 855, 402);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String lec=lecNameText.getSelectedItem().toString();
        ...
        crr.revenueReport(jTable1, "SELECT lecName,amount,date FROM lecturerpaid WHERE month='" + monthh + "' AND year='" + yearr + "' AND lecName='" + lec + "'", yearr);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String datee = oDateFormat.format(oDate);
         String lec=lecNameText.getSelectedItem().toString();
        companyRevenueReportMiddle crr=new companyRevenueReportMiddle();
        crr.revenueReport(jTable1, "SELECT lecName,amount,date FROM lecturerpaid WHERE  date='" + datee + "' AND lecName='" + lec + "'", datee);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lecturerReportClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lecturerReportClient().setVisible(true);
            }
        });
    }
