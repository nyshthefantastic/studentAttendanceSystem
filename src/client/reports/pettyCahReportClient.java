 ...
 * @author U Computers
 */
public class pettyCahReportClient extends javax.swing.JFrame {

    /**
     * Creates new form pettyCahReportClient
     */
    private static String page=null;
    public pettyCahReportClient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(70, 90, 61, 14);
        getContentPane().add(dateText);
        dateText.setBounds(254, 86, 214, 22);
        ...
        jButton1.setBounds(254, 142, 214, 23);
        ...
        jButton2.setBounds(254, 183, 214, 23);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        crr.revenueReport(jTable1, "SELECT reason,amount,date FROM pettycash WHERE month='" + monthh + "' AND year='" + yearr + "'", yearr);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        companyRevenueReportMiddle crr=new companyRevenueReportMiddle();
        crr.revenueReport(jTable1, "SELECT reason,amount,date FROM pettycash  WHERE date='" + datee + "' ", datee);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pettyCahReportClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pettyCahReportClient().setVisible(true);
            }
        });
    }
