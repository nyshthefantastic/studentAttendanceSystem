 ...
 * @author U Computers
 */
public class studentReportClient extends javax.swing.JFrame {

    private static String page;

    /**
     * Creates new form studentReportClient
     */
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(65, 126, 353, 170);

        jButton2.setText("STUDENT PAYMENT REPORT");
        getContentPane().add(jButton2);
        jButton2.setBounds(65, 496, 353, 171);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/defbackground.jpg"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-6, -6, 1210, 890);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        detailedAttendanceReportClient darc=new detailedAttendanceReportClient();
        darc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentReportClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentReportClient().setVisible(true);
            }
        });
    }
